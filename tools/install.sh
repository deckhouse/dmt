...
install_dmt() {
  ...
  if ! download_file "$download_url" "$tar_file"; then
    fmt_error "Failed to download DMT from ${download_url}"
...
${FMT_BOLD}Getting Started:${FMT_RESET}
  ...
  Run ${FMT_BOLD}${FMT_BLUE}dmt --help${FMT_RESET} to see available commands
