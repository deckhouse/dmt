...
var chartMaterial = map[string]bool{
	...
	// Generated by the build and imported straight into the image, so it exists in no
	// source tree. Requiring a pattern for a file the author never sees would fire on
	// every module built from the standard werf template.
