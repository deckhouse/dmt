...
func (r *CyrillicInEnglishRule) CheckFiles(m moduleInterface, errorList *errors.LintRuleErrorsList) {
...
func (r *CyrillicInEnglishRule) checkFile(m moduleInterface, fileName string, errorList *errors.LintRuleErrorsList) {
