...
| `module/disable-messages-without-requirement` | module linter `definition-file` (error: `disable.messages` without `requirements.deckhouse >= 1.77`) |
| `module/disable-messages-missing-language` | module linter `definition-file` (error: `disable.messages` missing `ru` or `en`) |
